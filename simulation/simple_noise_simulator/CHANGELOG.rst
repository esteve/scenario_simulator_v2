^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package simple_noise_simulator
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* fix compile erros in noise simulator package
* Merge branch 'master' into traffic_signal_actions
...
* fix compile errors
* fix noise frame update logic
* Merge pull request `#329 <https://github.com/tier4/scenario_simulator_v2/issues/329>`_ from tier4/fix/update_noise_frame_logic
* fix frame logic
...
* enable pass current time while attaching noise
