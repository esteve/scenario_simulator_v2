...
def launch_setup(context, *args, **kwargs):
    # planning_evaluator_param_path = LaunchConfiguration("planning_evaluator_param_path").perform(context)
    planning_evaluator_param_path = os.path.join(
        get_package_share_directory("planning_evaluator"),
        "param",
        "planning_evaluator.defaults.yaml",
    )
    with open(planning_evaluator_param_path, "r") as f:
        planning_evaluator_param = yaml.safe_load(f)["/**"]["ros__parameters"]
