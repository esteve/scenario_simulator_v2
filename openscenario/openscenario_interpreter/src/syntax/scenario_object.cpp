...
auto ScenarioObject::activateOutOfRangeMetric(const Vehicle & vehicle) const -> bool
{
  metrics::OutOfRangeMetric::Config configuration;
  {
    ...
    configuration.min_velocity = -parameters.performance.velocity_limit;
    configuration.max_velocity = +parameters.performance.velocity_limit;
    configuration.min_acceleration = -parameters.performance.deceleration_limit;
    configuration.max_acceleration = +parameters.performance.acceleration_limit;
